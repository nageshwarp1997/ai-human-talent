...
const RadarGraph = ({ selectedFiltrs, candidates }) => {
    ...
    const data = {
        labels: kpiAverageCount && Object.keys(kpiAverageCount)?.length > 0 ? Object.keys(kpiAverageCount) : [],
        datasets: [
            {
                label: "Average Candidate",
                data: kpiAverageCount && Object.keys(kpiAverageCount)?.length > 0 ? Object.values(kpiAverageCount) : [],
            ...
            {
                label: "AI Benchmark",
                data: kpiAICount && Object.keys(kpiAICount)?.length > 0 ? Object.values(kpiAICount) : [],
