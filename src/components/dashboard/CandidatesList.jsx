    ...
    return (
        <div>
            <div className="w-full overflow-x-auto my-4 ">
                <div className="flex flex-col md:flex-row items-center justify-between gap-4 mb-4">
                    ...
                    <div className="flex gap-2 text-[#263338]">
                        <button className="inline-flex items-center gap-1 border border-[#BFBEBE] px-3 py-1 rounded-sm text-sm">
                            <MdCompareArrows className="text-lg font-bold" /> Compare Candidates
                        </button>
                        <button className="inline-flex items-center gap-1 border border-[#BFBEBE] px-3 py-1 rounded-sm text-sm">
                ...
                <div className="max-h-[400px] overflow-auto" style={{ scrollbarWidth: "none" }}>
                    <table className="table-auto w-full text-sm text-left border-collapse max-h-[400px]">
                        ...
                        <tbody className="text-gray-800 max-h-[400px] overflow-auto" style={{ scrollbarWidth: "none" }}>
                            {candidates?.candidates?.map((candidate) => {
                                ...
                                return (
                                    <tr key={candidate?.orcid_id} className="border-b border-[#C7D2D2] hover:bg-gray-50">
                                        ...
                                        <td className="px-2 py-2 flex items-center gap-2 whitespace-nowrap overflow-hidden text-ellipsis max-w-[100px]">
                                            {regions?.find((region) => region?.value === candidate?.country)?.name}
                                        </td>
                                        <td className="px-2 py-2 whitespace-nowrap overflow-hidden text-ellipsis max-w-[100px]">
                                            {candidate?.city}
                                        </td>
                                        ...
                                        <td className="px-2 py-2 whitespace-nowrap overflow-hidden text-ellipsis max-w-[100px]">
                                            <span className="bg-gray-100 text-gray-600 px-2 py-1 rounded text-xs">50.10%</span>
                                        </td>
                            ...
                            {openDialogCandidate && (
                                <div className="fixed inset-0 bg-[#00000066] backdrop-blur-sm flex items-center justify-center z-50">
                                    <div className="bg-white rounded shadow p-6 max-w-xl w-full ">
                                        <h2 className="text-lg font-semibold mb-4">Candidate Summary</h2>
                                        <p className="max-h-[400px] overflow-auto">{openDialogCandidate}</p>
                                        <button
